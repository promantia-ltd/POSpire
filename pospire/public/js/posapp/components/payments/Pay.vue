...
export default {
	...
	methods: {
		...
		get_available_pos_profiles() {
			...
			return frappe
				.call("pospire.pospire.api.payment_entry.get_available_pos_profiles", {
		...
		get_outstanding_invoices() {
			...
			return frappe
				.call("pospire.pospire.api.payment_entry.get_outstanding_invoices", {
		...
		get_unallocated_payments() {
			...
			return frappe
				.call("pospire.pospire.api.payment_entry.get_unallocated_payments", {
					customer: this.customer_name,
					company: this.company,
					currency: this.pos_profile.currency,
				})
